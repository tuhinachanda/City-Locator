...
//     if (main.includes("snow")) return "Expect snowfall — bundle up and stay safe!";
//     if (main.includes("thunderstorm")) return "Thunderstorms likely — better to stay indoors.";
//     if (main.includes("rain") || main.includes("drizzle")) return "Rainy weather ahead — carry an umbrella!";
//     if (temp >= 30) return "It's quite hot outside — stay hydrated!";
//     if (temp <= 5) return "It's pretty cold — dress warmly!";
//     if (temp > 5 && temp < 18) return "Cool weather — a light jacket should do.";
//     if (temp >= 18 && temp < 30) return "Pleasant weather — enjoy your day!";
//     return "Weather is unusual — stay prepared!";
//   }

//   function getPollutionSummary(aqi) {
//     if (!aqi) return "";

//     const value = parseInt(aqi);

//     if (value <= 50) return "Air quality is good — perfect for outdoor activities.";
//     if (value <= 100) return "Moderate air quality — sensitive individuals should take care.";
//     if (value <= 150) return "Unhealthy for sensitive groups — limit prolonged outdoor exertion.";
//     if (value <= 200) return "Unhealthy air quality — consider staying indoors.";
//     if (value <= 300) return "Very unhealthy air quality — avoid outdoor activities.";
//     if (value <= 500) return "Hazardous air quality — stay indoors and wear protection if necessary.";
...
//             {pollution ? (
//               <div>
//                 <p><strong>AQI Value:</strong> {detailedAQI}</p>
//                 <p><strong>Category:</strong> {getAQICategory(detailedAQI)}</p>
//                 <p><strong>PM2.5 Concentration:</strong> {pollution.list[0].components.pm2_5} μg/m³</p>
//               </div>
//             ) : (
//               !pollutionError && <p>Loading air quality data...</p>
//             )}
...
//               <>
//                 <h2>Conclusion</h2>
//                 <p>{getWeatherSummary(weather)}</p>
//                 <p>{getPollutionSummary(detailedAQI)}</p>
//               </>
//             )}
//           </div>
//         ) : (
//           <p>Fetching your location data...</p>
//         )}
//       </div>
//     </>
//   );
...
function App() {
  ...
  // Additional precipitation note
  function getPrecipitationNote(weather) {
    if (!weather) return "";
    const main = weather.weather[0].main.toLowerCase();

    if (main.includes("rain") || main.includes("drizzle")) {
      return "There is a likelihood of rainfall in your area.";
    }
    if (main.includes("snow")) {
      return "Snowfall is expected in your area.";
    }
    return "No significant precipitation expected.";
  }
          ...
          <div>
            ...
            {(weather && detailedAQI) && (
              <>
                <h2>Conclusion</h2>
                <p>{getWeatherSummary(weather)}</p>
                <p>{getPrecipitationNote(weather)}</p>
                <p>{getPollutionSummary(detailedAQI)}</p>
              </>
            )}
          </div>
